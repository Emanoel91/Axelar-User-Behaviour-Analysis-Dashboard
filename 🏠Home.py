...
st.markdown(
    ...
    <div style="margin-top: 20px; margin-bottom: 20px; font-size: 16px;">
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
            ...
            <span>Dashboard Reference: <a href="hhttps://flipsidecrypto.xyz/Jor-el/axelar-user-behaviour-analysis-dashboard-b458Vh" target="_blank">https://flipsidecrypto.xyz/Jor-el/axelar-user-behaviour-analysis-dashboard-b458Vh/</a></span>
        </div>
        <div style="display: flex; align-items: center; gap: 10px;">
